...
import '../../widgets/coin_icon_wdget.dart';
import '../../widgets/correct_ans_widget.dart';
import '../../widgets/hint_popup_widget.dart';
...
class _PlayQuizScreenState extends State<PlayQuizScreen> {
    ...
    return ElevatedButton(
      ...
      child: Container(
        ...
        child: Text(
          letter,
          style:
              const TextStyle(fontSize: 16), // Adjust the font size as needed
        ),
      ),
    );
  }
  ...
  Widget buildSubmitButton() {
    ...
    return ElevatedButton(
      onPressed: () {
        if (widget.question[0].answer == typedAns.toString().toUpperCase()) {
          if (music.isSoundTurnedOn) {
            music.win();
          }
